   ...
   <div class="container">
    ...
    color: #000;">{{project.name}}</option>
                     ...
                     <div class="card mb-2">
                        ...
                        <div class="card-body">
                           <div class="col-md-8">
                              <a  :href="'/uploads/purchase_order/'+cycle.path" v-for="cycle in data.purchase_order_attachment" :key="cycle.id" download style="color: #222">  <span class="badge bg-danger">
                              {{cycle.path}}
                              </span></a>
                           </div>
                        </div>
            ...
            <div class="card">
               <div class="table-responsive">
                  <table class="table table-responsive-md">
                     ...
                     <tbody>
                        <tr v-for="(product,index) in data.attributes" :key="index">
...
this.payment_term = this.data.note,
...
this.products = this.data.purchase_order_attr,
this.project()
        },
