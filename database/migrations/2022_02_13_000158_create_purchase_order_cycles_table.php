...
class CreatePurchaseOrderCyclesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_cycles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchase_order_cycles');
    }
}
